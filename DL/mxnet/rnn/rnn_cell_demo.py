...
from new_bucket_io import MyBucketSentenceIter, default_build_vocab

data_dir = os.environ['HOME'] + "/data/mxnet/ptb/" 
...
if __name__ == '__main__':
    ...
    mod.fit(data_train, eval_data=data_val, num_epoch=num_epoch,
            ...
            optimizer_params={'learning_rate': learning_rate,
                'momentum': momentum, 'wd': 0.00001, 'clip_gradient': 5.0})
