...
do
	...
	CUDA_VISIBLE_DEVICES=0 ./bandwidthTest &>> $logfile
	echo -------2 convolution operation------- &>> $logfile
	CUDA_VISIBLE_DEVICES=0 ./convolutionSeparable &>> $logfile
	echo -------3 calculate histogram------- &>> $logfile
	CUDA_VISIBLE_DEVICES=0 ./histogram &>> $logfile
	echo -------4 matrix multiplication------- &>> $logfile
	CUDA_VISIBLE_DEVICES=0 ./matrixMulCUBLAS &>> $logfile
	echo -------5 matrix transpose------ &>> $logfile
	CUDA_VISIBLE_DEVICES=0 ./transpose &>> $logfile
